 ...
 */
public class Crypto_maxordering {

    final String TAG="Crypto_maxordering";
    //padding issues
    ...
    public String[] tablemaxordering = new String[169];
    ...
    void decrypt(Context ctx, Integer rid, String ek) throws Exception {
        ...
        ObjectUtils.debugLog(TAG,"Crypto_maxordering: length is "+encrypted.length );
    ...
    void writePlaintext(byte[] plaintext) {
        ...
        try {
            ...
            while((temp = bfReader.readLine()) != null)
            {
                ...
                tablemaxordering  [ct] =  temp.trim();  //same as index
